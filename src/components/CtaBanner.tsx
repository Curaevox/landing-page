...
export function CtaBanner() {
  ...
  return (
    <section className="mx-auto max-w-[1200px] px-6 pb-[80px] lg:px-8">
      <ScrollReveal>
        <div className="rounded-[16px] bg-ink px-[35px] py-[56px] text-center lg:px-[70px] lg:py-[80px]">
          <span className="inline-flex items-center gap-2 rounded-[999px] bg-signal px-3 py-1 text-[12px] font-medium text-white">
            <span className="block h-2 w-2 rounded-full bg-white" aria-hidden="true" />
            Live in weeks
          </span>
          <h2 className="mt-5 font-display text-[32px] font-semibold leading-[1.1] tracking-[-0.02em] text-white sm:text-[44px]">
